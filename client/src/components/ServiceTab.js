...
class ServiceTabExample extends Component {
  render() {
    ...
    let serviceTabContentData = [
      {
        bgUrl: "service3.jpg",
        contentTitle: "The Angular Course",
        contentDesc:
          "The Angular Firebase PWA Course will teach you how to build a complex progressive web app with Angular 9 (ivy  ",
        serviceLink: "service-details-left-sidebar"
      },
      {
        bgUrl: "service2.jpg",
        contentTitle: "Vue Firebase",
        contentDesc:
      ...
      {
        bgUrl: "service1.jpg",
        contentTitle: "Firebase Database: Understanding the Weird Parts",
        contentDesc:
          "Lorem ipsum dolor sit amet, consectet adipisicin elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
        serviceLink: "service-details-left-sidebar"
      },
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="section-title-area text-center">
                  <h2 className="section-title section-space--bottom--50" style={{color:"#fff"}}>
                    Most Viewed Courses 
                  </h2>
                </div>
              </div>
